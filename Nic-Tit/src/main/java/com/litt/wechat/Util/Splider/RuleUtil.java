...
public class RuleUtil {
	 ...
	 * @param datas
	 */
	public void print(List<Information> datas) {
		for (Information data : datas) {
			System.out.println(data.getInformationTitle());
			System.out.println(data.getInformationLink());
			System.out.println(data.getInformationTime());
			System.out.println("***********************************");
		}
	...
	public RuleUtil(String url, String[] params, String[] values,
