...
<body style="font-size: 60px;">
	 <div class="register">
		<div class="regTop">
			<span>共享反馈信息</span><br>
			<!-- <span style="color:red;margin-top: -2%;font-size: 25px;">(本部门共享信息)</span> -->
		</div>
		<div class="content" style="margin: 35px; height: 1700px;">
			<div class="message">
				<span  style=" margin-top:5px; margin-left:245px; color:red;margin-top: -2%;font-size: 40px;">[本部门共享业务]</span>
				...
				<form  id="submitform" action=" ${pageContext.request.contextPath }/handle/update" method="post">
					<table style="width: 100%; table-layout: fixed; border-spacing:0px 10px; font-size: 40px; margin-bottom: 40px; margin-top: 10px; ">
						<tr>
						...
						<tr>
							<td><label><strong>业务部门：</strong></label></td>
							<td><strong>${item.techsupportDepartment }</strong></td>
						</tr>
						<tr>
